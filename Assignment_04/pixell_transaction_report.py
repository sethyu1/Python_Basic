    ...
    with open('bank_data.csv', 'r') as csv_file:
        ...
        for row in reader:
            ...
            if transaction_type not in valid_transaction_types:
                valid_record = False
                error_message.append("Invalid transaction type")
            ...
            try:
                ...
                valid_record = False
                error_message.append("Non-numeric transaction amount")
            if valid_record:
            ...
            # Update the customer's account balance based on the transaction type
                ...
                error_record = (transaction_amount,error_message)
                rejected_records.append(error_record)
